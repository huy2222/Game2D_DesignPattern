...
// Cập nhật đường dẫn theo cấu trúc thư mục mới của bạn
...
import Player from "../classes/player/Player"; // Đã dùng class Player
...
export default class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Tạo player thông qua class Player thay vì viết code rời rạc trong GameScene
  ...
  update(time, delta) {
    ...
    // Gọi update từ class Player thay vì viết xử lý phím bấm ở đây
